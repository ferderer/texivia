...
function handleSearch() {
  if (searchQuery.value.trim()) {
    router.navigate(`/search?q=${encodeURIComponent(searchQuery.value)}`)
  }
}
      ...
      <div class="not-found-container">
        ...
        <div class="suggestions-section">
          ...
          <div class="suggestions-grid">
            <a v-for="suggestion in suggestions" :key="suggestion.title" :href="suggestion.href" class="suggestion-card">
        ...
        <div class="navigation-links">
          ...
          <button @click="goBack" class="nav-link secondary">
            ← Go Back
          </button>
        </div>
